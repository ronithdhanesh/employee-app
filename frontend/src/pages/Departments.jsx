            ...
            >
              ...
              <div className="mt-6 flex gap-2">
                <button
                  ...
                  className="cursor-pointer flex flex-1 items-center justify-center gap-2 rounded-xl border border-slate-200 py-2.5 font-medium text-slate-700 transition hover:bg-slate-100"
                >
                  <Pencil size={16} />
                  Edit
                </button>
                ...
                <button
                  ...
                  className="cursor-pointer flex flex-1 items-center justify-center gap-2 rounded-xl border border-red-200 py-2.5 font-medium text-red-600 transition hover:bg-red-50"
                >
                  <Trash2 size={16} />
                  Delete
                </button>
